...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER || "94763422146"  // Make SURE its Not Be Empty, Else Bot Stoped And Errors,
...
module.exports = {
  ...
  ownername: process.env.OWNER_NAME === undefined ? 'Sʜᴇʟʙʏㅤxㅤɴᴢᴇ' : process.env.OWNER_NAME,  
